...
- 🛠️ Core skills: Test Automation · Playwright · TypeScript · Selenium · Appium · Python · Robot Framework · API Testing · Performance Testing (k6) · CI/CD · Docker
- 🤖 Exploring: AI-assisted QA workflows using Claude API
- 📫 Reach me: [https://www.linkedin.com/in/khurrammuslim] or [khurram.muslim@gmail.com]
